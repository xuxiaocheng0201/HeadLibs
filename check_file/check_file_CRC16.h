#ifndef HLS_CHECK_FILE_CRC16_H
#define HLS_CHECK_FILE_CRC16_H
...
unsigned short CRC16_get(unsigned short crcinit,unsigned char *data, unsigned int len)
{
...
int CRC16_calc_img(const char *pFileName,unsigned int *uiCrcValue)
{
	...
	while(ReadFile(hFile,crcbuf,size,&rdlen,NULL),rdlen)
		crc=CRC16_get(crc,crcbuf,rdlen);
	CloseHandle(hFile);
	*uiCrcValue=crc;
	return 0;
}
...
#endif
//https://www.cnblogs.com/wlei588/p/5993287.html
